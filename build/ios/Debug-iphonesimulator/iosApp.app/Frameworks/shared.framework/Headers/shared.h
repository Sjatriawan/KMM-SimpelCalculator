...
- (double)addA:(double)a b:(double)b __attribute__((swift_name("add(a:b:)")));
- (double)divideA:(double)a b:(double)b __attribute__((swift_name("divide(a:b:)")));
- (double)multiplyA:(double)a b:(double)b __attribute__((swift_name("multiply(a:b:)")));
- (double)subtractA:(double)a b:(double)b __attribute__((swift_name("subtract(a:b:)")));
@end
...
+ (SharedCalculator *)createCalculator __attribute__((swift_name("createCalculator()")));
